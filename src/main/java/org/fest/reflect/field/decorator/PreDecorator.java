...
public class PreDecorator<T> extends DecoratorInvocationHandler<T> {
  ...
  @Override protected Object invokeFirst(Method method, Object[] args) throws IllegalArgumentException,
      IllegalAccessException, InvocationTargetException {
    return method.invoke(getDecorator(), args);
  }

  @Override protected Object invokeSecond(Method method, Object[] args) throws IllegalArgumentException,
      IllegalAccessException, InvocationTargetException {
    return method.invoke(getTarget(), args);
  }

  @Override protected Object getResult(Object firstResult, Object secondResult) {
