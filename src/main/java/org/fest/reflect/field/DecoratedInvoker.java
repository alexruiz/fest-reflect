...
public final class DecoratedInvoker<T> {
   ...
   * <p>
   * If {@link #ignoringDecoratorExceptions() ignoringDecoratorExceptions()} is used in combination with this method and an
   * exception is thrown, the default value will be returned (as defined by JLS) for all primitives or null for all non-primitive.
   * <p>
   * Example :<br>
