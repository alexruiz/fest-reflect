...
public class FieldDecoratorCombinedTest {
  ...
  @Test
  public void shouldPreDecorateFieldReturningDecoratorResultShieldingFromDecoratorExceptions() {
    // GIVEN
  ...
  @Test
  public void shouldPostDecorateFieldReturningDecoratorResultShieldingFromDecoratorExceptions() {
    // GIVEN
    IUploadFileService uploadFileServiceMock = mock(IUploadFileService.class);
    INotificationService notificationServiceMock = mock(INotificationService.class);
  ...
  @Test
  public void shouldPreDecoratorAndPostDecorateFieldReturningDecoratorResultShieldingFromDecoratorExceptions() {
    // GIVEN
    IUploadFileService uploadFileServiceMock = mock(IUploadFileService.class);
    INotificationService notificationServiceMock = mock(INotificationService.class);
