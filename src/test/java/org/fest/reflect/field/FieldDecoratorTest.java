...
public class FieldDecoratorTest {
	...
	@Test
	public void shouldAddDecoratorBeforeLoggerField() {
		// GIVEN
	...
	@Test
	public void shouldAddDecoratorAfterUploadFileService() {
		// GIVEN
	...
	@Test
	public void shouldAddDecoratorBeforeAndAfterUploadFileService() {
		// GIVEN
		IUploadFileService uploadFileServiceMock = mock(IUploadFileService.class);
		
		FileManager fileManager = new FileManager();

		field("uploadFileService").ofType(IUploadFileService.class).in(fileManager).addBefore(uploadFileServiceMock).addAfter(uploadFileServiceMock);
