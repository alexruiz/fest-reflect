...
public class Properties_Test {
  ...
  @Test public void should_throw_error_if_property_type_is_null() {
  ...
  @Test public void should_get_property_in_super_type() {
  ...
  @Test public void should_use_TypeRef_to_read_property() {
    Jedi jedi = new Jedi("Yoda");
    jedi.addPower("heal");
  ...
  @Test public void should_use_TypeRef_to_write_property() {
    Jedi jedi = new Jedi("Yoda");
