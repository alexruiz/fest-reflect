...
public class Methods_Test {
  ...
  @Test public void should_throw_error_if_method_return_type_is_null() {
  ...
  @Test public void should_throw_error_if_method_name_is_null() {
  ...
  @Test public void should_throw_error_if_method_name_is_empty() {
  ...
  @Test public void should_throw_error_if_method_return_TypeRef_is_null() {
  ...
  @Test public void should_throw_error_if_method_parameter_array_is_null() {
  ...
  @Test public void should_call_method_with_no_args_and_return_value() {
  ...
  @Test public void should_call_method_with_args_and_return_value() {
    jedi.addPower("healing");
    String power =
      Methods.methodWithReturnType(String.class).withName("powerAt").withParameterTypes(int.class).in(jedi).invoke(0);
    assertEquals("healing", power);
  }

  @Test public void should_call_method_with_no_args_and_return_TypeRef() {
    jedi.addPower("jump");
    List<String> powers =
      Methods.methodWithReturnType(new TypeRef<List<String>>() {}).withName("powers").withNoParameters().in(jedi).invoke();
    assertEquals(1, powers.size());
    assertEquals("jump", powers.get(0));
  }

  @Test public void should_call_method_with_args_and_return_TypeRef() {
    jedi.addPower("healing");
    jedi.addPower("jump");
    List<String> powers =
      Methods.methodWithReturnType(new TypeRef<List<String>>() {}).withName("powersThatStartWith").withParameterTypes(String.class).in(jedi).invoke("ju");
    assertEquals(1, powers.size());
    assertEquals("jump", powers.get(0));
  }
